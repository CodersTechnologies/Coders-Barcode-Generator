 ...
 * @author sunny
 */
public class CodersBarcodeGeneratorSolo {
    
    public static final String DEST = "results/barcodes/1-1000.pdf";
    ...
    public static PdfPCell createBarcode(PdfWriter writer, String code) throws DocumentException, IOException {
        ...
        cell.setPadding(5);//To set spacing within cell before and after barcode
        return cell;
    }
    ...
    public static void main(String[] args) throws IOException, DocumentException {
        ...
        new CodersBarcodeGeneratorSolo().createPdf(DEST);
    }
